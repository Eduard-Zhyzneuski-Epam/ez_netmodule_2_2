...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-11-13 11:50:08',NULL),('diagnostics.include_raw','OFF','2022-11-13 11:50:08',NULL),('ps_thread_trx_info.max_length','65535','2022-11-13 11:50:08',NULL),('statement_performance_analyzer.limit','100','2022-11-13 11:50:08',NULL),('statement_performance_analyzer.view',NULL,'2022-11-13 11:50:08',NULL),('statement_truncate_len','64','2022-11-13 11:50:08',NULL);
...
-- Dump completed on 2022-11-14 23:45:21
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
...
CREATE TABLE `category` (
  ...
  KEY `FK_ParentCategory_idx` (`ParentCategoryId`),
  CONSTRAINT `FK_ParentCategory` FOREIGN KEY (`ParentCategoryId`) REFERENCES `category` (`Id`)
...
INSERT INTO `category` VALUES (1,'Courses',NULL,NULL),(2,'.NET Courses',NULL,1),(4,'Python courses','https://www.python.org/static/img/python-logo@2x.png',1),(5,'Glasses',NULL,NULL),(6,'Cups',NULL,NULL),(7,'ASP.NET Courses',NULL,2);
...
INSERT INTO `item` VALUES (1,'Advanced .NET',NULL,NULL,2,20.00,30),(2,'Maching learning','Cause ML is pythonic =)',NULL,4,20.00,30),(3,'EPAM Glass',NULL,'https://www.epam.com/content/dam/epam/global/logo_white-blue.svg',5,5.00,100),(4,'EPAM Cup',NULL,'https://www.epam.com/content/dam/epam/global/logo_white-blue.svg',6,3.50,100);
